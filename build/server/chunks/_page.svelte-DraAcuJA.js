...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { data, form } = $$props;
    head("ezi9n0", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>Pró-formas | FACT FLEXI</title>`);
      });
    });
    Documento_fiscal_form($$renderer2, {
      ...
      titulo: "Nova Factura Pro-Forma",
      descricao: "Emissão de Factura Pro-Forma (FP)",
      loading: false,
      onCancel: () => goto()
    });
  });
...
//# sourceMappingURL=_page.svelte-DraAcuJA.js.map
