...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { data, form } = $$props;
    head("pmwpyg", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>Nova Fatura de Adiantamento | FACT FLEXI</title>`);
      });
    });
    Documento_fiscal_form($$renderer2, {
      ...
      titulo: "Nova Fatura de Adiantamento",
      descricao: "Registo de adiantamento financeiro",
      loading: false,
      onCancel: () => goto(),
      config: {
...
//# sourceMappingURL=_page.svelte-DBwwd7mh.js.map
