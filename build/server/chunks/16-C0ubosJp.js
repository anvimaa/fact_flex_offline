...
const index = 16;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-DkuGyKHs.js')).default;
const server_id = "src/routes/(app)/cadastros/clientes/+page.server.ts";
...
//# sourceMappingURL=16-C0ubosJp.js.map
