import { g as get, w as writable, d as derived, a as readonly } from './index2-Cz2gv4fD.js';
import { p as page, n as navigating } from './stores-BBk2HDxH.js';
import { S as SuperFormError, a as shapeFromObject, c as clone$1, b as splitPath, d as setPaths, p as pathExists, u as updateErrors, e as mapErrors, f as comparePaths, t as traversePath, g as traversePaths, h as mergePath, i as flattenErrors } from './zod-vsheQqNr.js';
import { D as DEV } from './index-DPRpZFUH.js';
import { o as onDestroy, t as tick } from './index-server-CziyT60N.js';
import { a as applyAction, i as invalidateAll } from './client2-CcJ2Tk7F.js';
import { s as stringify, b as app } from './app-L81mENw7.js';
...
function superForm(form, formOptions) {
  ...
  let initialValidator = void 0;
  {
    ...
    if (options.dataType !== "json") {
      const checkForNestedData = (key, value) => {
        ...
        } else if (!(value instanceof Date) && !(value instanceof File) && !DEV) {
  ...
  function Form_set(data, options2 = {}) {
    if (options2.keepFiles) {
      traversePaths(Data.form, (info) => {
        if (info.value instanceof File || DEV) {
  ...
  function Form_reset(opts = {}) {
    ...
    const currentTainted = clone$1(__data.tainted);
    const newTainted = {};
...
//# sourceMappingURL=superForm-Bw4SE-EW.js.map
