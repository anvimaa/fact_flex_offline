import { ax as store_get, ay as unsubscribe_stores, av as head, aE as store_mutate, aw as attr, _ as derived } from './index-DPRpZFUH.js';
  ...
  $$renderer.component(($$renderer2) => {
    ...
    const { form, errors, message, delayed } = superForm(data.form, {
      onUpdated: ({ form: form2 }) => {
        if (form2.valid) {
          toast.success(store_get($$store_subs ??= {}, "$message", message) || "Produto criado com sucesso!");
          goto();
        }
      }
    });
    ...
    function $$render_inner($$renderer3) {
      head("183lz52", $$renderer3, ($$renderer4) => {
        $$renderer4.title(($$renderer5) => {
          $$renderer5.push(`<title>Novo Produto | FACT FLEXI</title>`);
        });
      });
      ...
      $$renderer3.push(`<!----> <div><h1 class="text-3xl font-bold tracking-tight">Novo Produto</h1> <p class="text-muted-foreground">Cadastre um novo item ou serviço no seu catálogo</p></div></div> <div class="flex items-center gap-3">`);
      Button($$renderer3, {
        variant: "outline",
        href: "/cadastros/produtos",
        children: ($$renderer4) => {
      ...
      Button($$renderer3, {
        ...
        children: ($$renderer4) => {
          ...
          $$renderer4.push(`<!--]--> Salvar Produto`);
        },
        $$slots: { default: true }
      });
      $$renderer3.push(`<!----></div></div> `);
      Separator($$renderer3, {});
      $$renderer3.push(`<!----> <form id="new-product-form" method="POST" class="grid gap-6 lg:grid-cols-3"><div class="space-y-6 lg:col-span-2">`);
      Card($$renderer3, {
...
//# sourceMappingURL=_page.svelte-CbAaNMBw.js.map
