...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      head("b3795", $$renderer3, ($$renderer4) => {
        $$renderer4.title(($$renderer5) => {
          $$renderer5.push(`<title>Novo Cliente | FACT FLEXI</title>`);
        });
      });
      ...
      $$renderer3.push(`<!----> <div><h1 class="text-3xl font-bold tracking-tight">Novo Cliente</h1> <p class="text-muted-foreground">Cadastre um novo cliente no seu sistema</p></div></div> <div class="flex items-center gap-3">`);
      Button($$renderer3, {
        variant: "outline",
        href: "/cadastros/clientes",
        children: ($$renderer4) => {
      ...
      Button($$renderer3, {
        ...
        children: ($$renderer4) => {
          ...
          $$renderer4.push(`<!--]--> Salvar Cliente`);
        },
        $$slots: { default: true }
      });
      $$renderer3.push(`<!----></div></div> `);
      Separator($$renderer3, {});
      $$renderer3.push(`<!----> <form id="new-client-form" method="POST" class="grid gap-6 lg:grid-cols-3"><div class="space-y-6 lg:col-span-2">`);
      Card($$renderer3, {
      ...
      Card($$renderer3, {
        ...
        children: ($$renderer4) => {
          Card_header($$renderer4, {
            children: ($$renderer5) => {
              Card_title($$renderer5, {
                class: "text-sm",
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->Dicas de Cadastro`);
                },
                $$slots: { default: true }
              });
            },
          ...
          Card_content($$renderer4, {
            ...
            children: ($$renderer5) => {
              $$renderer5.push(`<ul class="list-disc space-y-2 pl-4"><li>Utilize a busca por NIF para preencher automaticamente o nome e tipo do cliente.</li> <li>O endereço é obrigatório para a emissão correta de documentos fiscais.</li> <li>Certifique-se de que o e-mail está correto para o envio automático de faturas.</li></ul>`);
            },
            $$slots: { default: true }
          });
          $$renderer4.push(`<!---->`);
...
//# sourceMappingURL=_page.svelte-Cc7VZYMn.js.map
