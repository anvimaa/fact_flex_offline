...
const actions = {
  emitir: async ({ request }) => {
    ...
    if (!clienteId || !dataEmissao || !dataVencimento || !moeda || !itensJSON) {
    ...
    try {
      ...
      return {
        success: true,
        message: "Factura Pro-Forma emitida com sucesso",
        documentoId: documento.id,
        numero: documento.numero
      };
    } catch (error) {
      console.error("Erro ao emitir pro-forma:", error);
      return fail(500, { error: error.message || "Erro ao emitir pro-forma" });
    }
  }
};
