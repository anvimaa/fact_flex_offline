...
const load = async ({ params }) => {
  ...
  const form = await superValidate(cliente, zod(clienteSchema));
  return {
    form
  };
};
const actions = {
  default: async ({ request, params }) => {
    ...
    try {
      ...
      return fail(500, { form, error: "Erro ao atualizar cliente" });
    }
  }
};
