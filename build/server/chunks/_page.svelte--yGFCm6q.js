...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { data } = $$props;
    head("16ef5pp", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>FACT FLEXI | Proforma #${escape_html(data.factura.numero)}</title>`);
      });
    });
...
//# sourceMappingURL=_page.svelte--yGFCm6q.js.map
