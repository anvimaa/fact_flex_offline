...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { data, form } = $$props;
    head("1a37xxd", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>Nova Fatura-Recibo | FACT FLEXI</title>`);
      });
    });
    Documento_fiscal_form($$renderer2, {
      ...
      titulo: "Nova Fatura-Recibo",
      descricao: "Emissão e recebimento simultâneo (Pronto Pagamento)",
      loading: false,
      onCancel: () => goto(),
      config: { pagamentoObrigatorio: true, mostraRetencao: true }
    });
  });
}

export { _page as default };
//# sourceMappingURL=_page.svelte-DboTPf4i.js.map
